...
<div class="tracking-sec" data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" class="scrollspy-example" tabindex="0">
     <div class="container pt-3" id="home">
          ...
          <div class="container w-75 pt-5">
               ...
               <div class="">
                    <p>Swift Delivery Cargo Express Reference Tracking></p>
               </div>
               ...
               <div class="col-lg-3">
                    <div class="card text-dark mb-3 card-inquiry bg-white card-for-buz courser-pointer">
                         <div class="card-body text-center ">
                              ...
                              <h6 class="card-text hoverDesc">
                                   Swift Delivery Cargo For Business
                              </h6>
                              <p class="card-text fwt-sm fw-light">
                    ...
                    <div class="row">
                         <div class="col-lg-6 side-sect pt-3 ms-auto">
                              <div class="container-fluid">
                                   ...
                                   <p>
                                        Shipping saints connects people in over 220 countries and territories worldwide. Driven by the power of more than 400,000 employees, we deliver integrated services and
               ...
               <div class="row">
                    ...
                    <div class="col-lg-3">
                         <div>
                              ...
                              <p class="card-text-hover fw-1">Swift Delivery Cargo Express</p>
                              <p class="card-text-hover fw-1">Swift Delivery Cargo Global Forwarding</p>
                              <p class="card-text-hover fw-1">Swift Delivery Cargo Freight</p>
                              <p class="card-text-hover fw-1">Swift Delivery Cargo Supply Chain</p>
                              <p class="card-text-hover fw-1">Swift Delivery Cargo eCommerce solution</p>
                         </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                         <div>
                              ...
                              <p class="card-text-hover fw-1"> About Swift Delivery Cargo</p>
